...
public class ExpandableDutyAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<String> expandableListTitle;
    private TreeMap<String, List<User>> expandableListDetail;

    public ExpandableDutyAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        final User contactEntity = (User) getChild(i, i1);
        if (view == null) {
            LayoutInflater layoutInflater = (LayoutInflater) viewGroup.getContext()
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            try {
        ...
        ctv.setCustomText(contactEntity.getFirstName().toUpperCase());
        ctv.setSolidColor(i);
        ctv.setTextColor(Color.WHITE);
        name.setText(contactEntity.getFirstName()+" "+contactEntity.getLastName());
        contact.setText(contactEntity.getPhone());
        return view;
    }
